...
class _AchatEnCoursState extends State<AchatEnCours> {
  ...
  Future<void> _loadVentesEnCours() async {
    ...
    setState(() {});
    futureVenteEnCour = ConsommateurRepository()
        .getVenteEncour(consommateur?.consommateurphone);
                  ...
                  child: Column(
                    children: VenteEnCour != null && VenteEnCour!.isNotEmpty
                        ? VenteEnCour!.map((vente) {
                            return AchatsEnCoursItem(
                              productType: vente.venteProduit.toString(),
                              name: vente.venteProduit.toString(),
                              price: vente.ventePrix!.toInt(),
                              weight: vente.venteQuantite!.toString(),
                              label:
                                  "Dans ${vente.tempsLivraison.toString()} jours",
                            );
                          }).toList()
                        : [
                          Center(child: Image.asset("assets/undraw_empty_cart_co35.png", scale: 5,)),
                            const Center(
                              child: Text(
                ...
                child: InkWell(
                  onTap: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (builder) => const HistoriqueDesAchats()));
                  },
                  child: Container(
                    width: 200,
                    height: 40,
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          Image.asset(
                            "assets/icons/icons8-poids-90-orange.png",
                            scale: 5,
                          ),
                          const SizedBox(
                            width: 5,
