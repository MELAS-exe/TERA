...
class TopRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    List<String> nameList = name != null ? name!.split(" ") : [" "];
    return Column(
      ...
      children: [
            ...
            InkWell(
              onTap: () => {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (builder) => const AchatEnCours()))
              },
              child: Container(
        ...
        Text(
          "Bonjour ${nameList[0]},",
          style: const TextStyle(fontFamily: "Lilly", fontSize: 30),
        ),
        const Text(
          "Bienvenue dans la boutique Tera,",
          style: TextStyle(
